      ...
      try {
        ...
        g2ChartInstance.current
          .data({
            type: "fetch",
            value:
              "https://gw.alipayobjects.com/os/antvdemo/assets/data/stock-03.json",
          })
          .encode("x", "date")
          .scale("color", {
            domain: ["down", "up"],
        ...
        console.error(
          "Error initializing G2 chart from integration/G2/site/examples/general/candlestick/demo/k-and-area.ts:",
          error
        )
        if (chartRef.current) {
          chartRef.current.innerHTML =
            '<div style="color: red; text-align: center; padding: 20px;">Failed to render G2 chart. Check console for errors. Source: integration/G2/site/examples/general/candlestick/demo/k-and-area.ts</div>'
        }
      }
    }
    ...
    return () => {
      if (g2ChartInstance.current) {
        try {
          ...
          console.error(
            "Error destroying G2 chart from integration/G2/site/examples/general/candlestick/demo/k-and-area.ts:",
            e
          )
        }
